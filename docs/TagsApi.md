...
------------- | ------------- | -------------
[**add_tag**](TagsApi.md#add_tag) | **POST** /Scan/Tags | Add a tag
[**delete_tag**](TagsApi.md#delete_tag) | **DELETE** /Scan/Tags/{tagID} | Delete a tag by ID
[**get_tag**](TagsApi.md#get_tag) | **GET** /Scan/Tags/{tagID} | Get a tag by ID
[**get_tags**](TagsApi.md#get_tags) | **GET** /Scan/Tags | List all tags
...
api_instance = layint_api.TagsApi()
tag = layint_api.Tag() # Tag | Name of the tag to be added
