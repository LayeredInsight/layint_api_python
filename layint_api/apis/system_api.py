...
class SystemApi(object):
    ...
    def health_check_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/HealthStatus', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def system_status_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.system_status_get(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.system_status_get_with_http_info(**kwargs)
        else:
            (data) = self.system_status_get_with_http_info(**kwargs)
            return data

    def system_status_get_with_http_info(self, **kwargs):
        """
        Returns information about components running on the system
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.system_status_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method system_status_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/SystemStatus', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
