...
class Image(object):
    ...
    def push_registry(self):
        """
        Gets the push_registry of this Image.
        ...
        :return: The push_registry of this Image.
        :rtype: str
        """
    ...
    def push_registry(self, push_registry):
        """
        Sets the push_registry of this Image.
        12 character hexadecimal internal identifier to layered insight record defining the push registry for a layered version of this image

        :param push_registry: The push_registry of this Image.
        :type: str
        """
    ...
    def push_name(self, push_name):
        """
        Sets the push_name of this Image.
        Layered Image name for push registry (-layered tag will still be appended)

        :param push_name: The push_name of this Image.
        :type: str
        """
    ...
    def scan_status(self):
        """
        Gets the scan_status of this Image.
        Current status of the scan of this image

        :return: The scan_status of this Image.
        :rtype: str
        """
    ...
    def scan_status(self, scan_status):
        ...
        :param scan_status: The scan_status of this Image.
        :type: str
        """
        allowed_values = ["pending", "done", "failed"]
        if scan_status not in allowed_values:
            raise ValueError(
                "Invalid value for `scan_status` ({0}), must be one of {1}"
